 ...
 *  Martin Schläffer
*/
#include "ascon_api.hpp"
#include "ascon.hpp"
#include "ascon_crypto_aead.hpp"
#include "ascon_permutations.hpp"
...
int crypto_aead_encrypt(unsigned char* c, unsigned long long* clen,
  ...
  // otLogNotePlat("Begin ASCON encryption.");
  (void)nsec;
  ...
  *clen = mlen + CRYPTO_ABYTES;
  ...
  // otLogNotePlat("End ASCON encryption.");
  return 0;
}
...
int crypto_aead_decrypt(unsigned char* m, unsigned long long* mlen,
                        ...
                        const unsigned char* k) {
  // otLogNotePlat("Begin ASCON decryption.");
  (void)nsec;
  ...
  *mlen = clen - CRYPTO_ABYTES;
  ...
  // otLogNotePlat("End ASCON decryption.");
  return result;
}
